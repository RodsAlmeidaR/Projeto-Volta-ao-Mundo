            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Densidade Demográfica</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>131.957 km²</td>
                        <td>10,43 milhões (2022)</td>
                        <td>84,5 hab/km²</td>
                    </tr>
                </tbody>
                <thead>
                    <tr>
                        ...
                        <th scope="col">PIB</th>
                        <th scope="col">Principal fonte de renda</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>Euro</td>
                        <td>217,6 bilhões USD (2022)</td>
                        <td>Indústrias, finanças, turismo e agricultura</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-2">
            <img src="img/Cultura/platao_escultura.jpg" class="img-fluid img-with-border" alt="Imagem"> 
        </div>
        <div class="col-md-10">
            <h3>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-2">
            <img src="img/Cultura/teatro.jpg" class="img-fluid img-with-border" alt="Imagem">
        </div>
    </div>
</div>
